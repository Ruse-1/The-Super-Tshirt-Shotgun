...
Initial Research/Design (1.0 Hour)
...
This is their cannon they made, I am most likely gonna have similar build methods.
...
Started BOM And Air Tank CAD (3.0 Hours)
...
It's pretty rough, most of it is more or less very simple geometry to use as reference. The parts are the right sizes, and if I get around to it, I might replace it with proper models, but good enough for now. 
On the BOM, I managed to find the right brass fittings, I was making sure the threading was all correct.

Actually got Plumbing Relatively Done (2.5 Hours)
Spent like 2-3 hours trying to find the right tubing and valves for the back, it was not fun. I might still need to find smaller hoses, but for now, I have all the parts for the back plumbing done. 

I don’t really have a picture so here’s the tee brass connector I’m using.
...
November 15 2025 5.5 Hours

Ok, For real Finished Plumbing I hope - (1.0 hour) Fisrt Journal
...
Almost complete CAD Assembly (3.5 hours) - Second Journal
<img width="830" height="461" alt="image" src="https://github.com/user-attachments/assets/f6cc8ef6-ffe3-4943-a019-6e1cab0418f7" />

I am close to finishing the main cad assembly of my design. My worry now is the price. My BOM is over 300$, and I have already began considering a redesign. The price is 300$ without the PVC pipe, should I redesign for a cheaper price?

Firing Mechanism CAD/Main Assem (1.0 Hours) - Third Journal
<img width="832" height="430" alt="image" src="https://github.com/user-attachments/assets/3f715c53-79a8-4b89-8f86-652875a51f4b" />

I finished the firing mechanism CAD of the cannon, and now all that is left is to finish the BOM, finish the assembly, refine some of the models and add the hose.
<img width="835" height="451" alt="image" src="https://github.com/user-attachments/assets/286e09d3-5dee-4d93-b9f8-95beb6c6488a" />

^^
ROUGH MAIN ASSEM DONE :tada
fixing the plumbing in the back with proper models (I love mcmaster carr so much), add hose, and then review bom with others.

Changes not mentioned yet today - (0.5 Hours)
First, changed length of the firing barrels. They used to be 18in, but for cost purposes, it's been reduced to 1ft each. 
<img width="828" height="225" alt="image" src="https://github.com/user-attachments/assets/687bc33a-d42f-4603-a0ef-1006de7ad6d6" />
...
November 16 2025 1.5 Hours

ok so about me finishing plumbing (1.5 Hours)
<img width="829" height="596" alt="image" src="https://github.com/user-attachments/assets/20a56d05-27f1-4eab-a58c-78e997778f5b" />

NOW for real its actually hopefully finished. I changed the sizing of all the plumbing in the back to 1/8in NPT, and changed the Reducer Couplings for the firing mechanism from 3inx 1.5 to 3in x 2in because it was like a lot cheaper lol.
Now everything should have its proper cad model, all remaining is finish setting up my github, review and rework bom, and add a hose. And i dont know how to do 3d sketches so. yay. 
